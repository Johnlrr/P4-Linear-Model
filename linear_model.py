...
def train_basic_models(data_path='data/train.csv', out_dir='models'):
    ...
    X_o3, y_o3, X_no2, y_no2 = feature_engineering_basic(df)
    Xo3_train, Xo3_val, yo3_train, yo3_val = split_data(X_o3, y_o3)
    Xn2_train, Xn2_val, yn2_train, yn2_val = split_data(X_no2, y_no2)
